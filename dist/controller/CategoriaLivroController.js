...
let CategoriaLivroController = class CategoriaLivroController extends tsoa_1.Controller {
    ...
    listarCategoriasLivro(fail, success) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const categoriasLivro = yield this.categoriaLivroService.getCategoriasLivro();
                return success(200, new BasicResponseDto_1.BasicResponseDto('Lista de categorias de livros', categoriasLivro));
            }
            catch (error) {
